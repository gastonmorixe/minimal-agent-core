...
describe("renderEcho", () => {
  it("emits scope + id + body for short bodies", () => {
    ...
    expect(out).toBe('<memory-saved scope="project" id="abc-1234">hi</memory-saved>')
  })
    ...
    expect(blocks).toEqual([
      {
        type: "text",
        text:
          '<memory-saved scope="project" id="lwq8tg-a8f3">Project memory body example</memory-saved>',
      },
    ])
