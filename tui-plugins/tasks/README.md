...
```sh
bun run tui-plugins/tasks/cli.ts list
bun run tui-plugins/tasks/cli.ts add "Make plan visible"
bun run tui-plugins/tasks/cli.ts done 1
bun run tui-plugins/tasks/cli.ts status 2 canceled "user redirected"
```
