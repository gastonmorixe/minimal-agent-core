...
Captures `<tui::interleave-thinking>...</tui::interleave-thinking>`
...
|---|---|---|
| Inline tag | `<tui::interleave-thinking>` | `handlers/interleave.ts` |
...
`<tui::interleave-thinking>` the model emits will fall through to the
