...
const BASELINE = new Map<string, number>([
  ["config/handlers/cmd_config.ts", 1],
  ["config/handlers/on_key.ts", 1],
  ["diagnostics/lib/structural-contract.test.ts", 1],
  ["diff-view/handlers/inline_diff.ts", 1],
  ["diff-view/handlers/show_diff.ts", 1],
  ...
  ["history/handlers/on_key.ts", 1],
  ["history/handlers/on_submit.ts", 1],
  ["history/integration.test.ts", 1],
  ["interleave-thinking/handlers/interleave.ts", 2],
  ["llm-anthropic/adapter.preflight.test.ts", 2],
  ["llm-anthropic/adapter.ts", 9],
  ...
  ["llm-anthropic/session-info.ts", 6],
  ...
  ["llm-openai/adapter.ts", 8],
  ["llm-openai/capabilities.ts", 2],
  ["llm-openai/chat/request-body.ts", 5],
  ["llm-openai/headers.ts", 1],
  ["llm-openai/models.ts", 2],
  ["llm-openai/openai.test.ts", 1],
  ["llm-openai/pricing.ts", 1],
  ["llm-openai/responses/request-body.ts", 5],
  ["llm-openai/responses/response-stream.ts", 1],
  ["llm-openai/session-info.test.ts", 1],
  ["llm-openai/validate.ts", 5],
  ["llm-openrouter/adapter.ts", 7],
  ["llm-openrouter/capabilities.ts", 2],
  ["llm-openrouter/models.ts", 2],
  ...
  ["model-info/handlers/model-info.test.ts", 1],
  ["model-info/handlers/model-info.ts", 1],
  ...
  ["session-info/handlers/session-info.ts", 1],
  ["session-info/lib/gather.ts", 4],
  ["sub-agents/handlers/agent_output.ts", 1],
  ["sub-agents/handlers/agent_result.ts", 1],
  ["sub-agents/handlers/agent_status.ts", 1],
  ["sub-agents/handlers/heartbeat.ts", 1],
  ["sub-agents/handlers/list_agents.ts", 1],
  ["sub-agents/handlers/mailbox.ts", 1],
  ["sub-agents/handlers/report_result.test.ts", 1],
  ["sub-agents/handlers/report_result.ts", 1],
  ["sub-agents/handlers/spawn_agent.ts", 1],
  ["sub-agents/handlers/stop_agent.ts", 1],
  ["sub-agents/lib/attachment.ts", 1],
  ["sub-agents/lib/handler-deps.test.ts", 1],
  ["sub-agents/lib/handler-deps.ts", 1],
  ["sub-agents/lib/progress.ts", 1],
  ["sub-agents/lib/prompts.ts", 1],
  ["sub-agents/load.test.ts", 1],
  ["tasks/handlers/planning_fragment.test.ts", 1],
  ["tasks/handlers/planning_fragment.ts", 1],
  ["tasks/handlers/task_link.test.ts", 1],
  ["tasks/handlers/task_link.ts", 1],
  ["tasks/handlers/task_tool.test.ts", 1],
  ["tasks/handlers/task_tool.ts", 1],
  ["tasks/integration.test.ts", 1],
  ["tasks/lib/attachment.ts", 1],
  ["usage/handlers/cmd_usage.ts", 2],
  ["usage/handlers/on_key.ts", 1],
  ["usage/lib/overlay.test.ts", 2],
  ["usage/lib/overlay.ts", 2],
  ["usage/lib/state.test.ts", 1],
  ["usage/lib/state.ts", 1],
  ["web-search/config.ts", 1],
  ["web-search/handlers/web_search.test.ts", 1],
  ["web-search/handlers/web_search.ts", 1],
