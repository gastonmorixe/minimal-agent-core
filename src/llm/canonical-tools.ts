 ...
 *   {name, description, parameters, strict?}}` for user-defined;
 *   server tools live elsewhere (most are Responses-only).
 * - **OpenAI Responses**: flat `{type: "function", name, description,
